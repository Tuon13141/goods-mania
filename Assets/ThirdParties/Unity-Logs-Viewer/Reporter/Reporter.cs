...
public class ReporterData
{
    ...
    public bool clearOnNewSceneLoaded;
...
public class Reporter : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        var reporterData = JsonUtility.FromJson<ReporterData>(PlayerPrefs.GetString("Reporter_Data", JsonUtility.ToJson(new ReporterData())));

        currentView = (ReportView)reporterData.currentView;
        show = reporterData.show;
        collapse = reporterData.collapse;
        clearOnNewSceneLoaded = reporterData.clearOnNewSceneLoaded;
        showTime = reporterData.showTime;
        showScene = reporterData.showScene;
        showMemory = reporterData.showMemory;
        showFps = reporterData.showFps;
        showGraph = reporterData.showGraph;
        showLog = reporterData.showLog;
        showWarning = reporterData.showWarning;
        showError = reporterData.showError;
        filterText = reporterData.filterText;
        size.x = size.y = reporterData.size;


        showClearOnNewSceneLoadedButton = reporterData.showClearOnNewSceneLoadedButton;
        showTimeButton = reporterData.showTimeButton;
        showSceneButton = reporterData.showSceneButton;
        showMemButton = reporterData.showMemButton;
        showFpsButton = reporterData.showFpsButton;
        showSearchText = reporterData.showSearchText;
        showCopyButton = reporterData.showCopyButton;
        showSaveButton = reporterData.showSaveButton;
    ...
    void drawToolBar()
    {
        ...
        toolBarRect.x = 0f;
        toolBarRect.y = Screen.height - (Screen.safeArea.y + Screen.safeArea.height);
    ...
    {
        topPadding = Screen.height - (Screen.safeArea.y + Screen.safeArea.height);
        bottomPadding = Screen.safeArea.y;
        ...
        logsRect.x = 0f;
        logsRect.y = topPadding + size.y * 2f;
        logsRect.width = Screen.width;
        logsRect.height = Screen.height * 0.75f - size.y * 2f - topPadding;

        stackRectTopLeft.x = 0f;
        stackRectTopLeft.y = Screen.height * 0.75f;

        stackRect.x = 0f;
        stackRect.y = Screen.height * 0.75f + topPadding;
        stackRect.width = Screen.width;
        stackRect.height = 0;// Screen.height * 0.25f - size.y - bottomPadding - topPadding;



        detailRect.x = 0f;
        detailRect.y = Screen.height - size.y * 3 + bottomPadding;
    ...
    {
        var reporterData = new ReporterData();

        reporterData.currentView = (int)currentView;
        reporterData.show = show;
        reporterData.collapse = collapse;
        reporterData.clearOnNewSceneLoaded = clearOnNewSceneLoaded;
        reporterData.showTime = showTime;
        reporterData.showScene = showScene;
        reporterData.showMemory = showMemory;
        reporterData.showFps = showFps;
        reporterData.showGraph = showGraph;
        reporterData.showLog = showLog;
        reporterData.showWarning = showWarning;
        reporterData.showError = showError;
        reporterData.filterText = filterText;
        reporterData.size = size.x;

        reporterData.showClearOnNewSceneLoadedButton = showClearOnNewSceneLoadedButton;
        reporterData.showTimeButton = showTimeButton;
        reporterData.showSceneButton = showSceneButton;
        reporterData.showMemButton = showMemButton;
        reporterData.showFpsButton = showFpsButton;
        reporterData.showSearchText = showSearchText;
        reporterData.showCopyButton = showCopyButton;
        reporterData.showSaveButton = showSaveButton;

        PlayerPrefs.SetString("Reporter_Data", JsonUtility.ToJson(reporterData));
        PlayerPrefs.Save();
    }
